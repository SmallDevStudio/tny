    ...
    <section className="bg-white dark:bg-gray-800">
      <div className="py-4 px-4 w-full lg:py-6 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center lg:mb-1 ">
          <h2 className="text-2xl lg:text-4xl font-extrabold text-gray-900 dark:text-orange-500">
      ...
      <div className="grid max-w-screen-xl mx-auto px-4 py-8 lg:grid-cols-2 gap-6">
