      ...
      <div className="flex flex-col justify-center xl:w-1/4 lg:w-1/4 md:w-1/3 sm:w-1/2">
        ...
        <div className="flex flex-col border text-black border-gray-200 rounded-xl w-full text-sm p-4 mt-2 shadow-xl bg-white">
          <div className="flex flex-col w-full">
            <span className="flex text-2xl text-black font-bold mb-1">
              เข้าสู่ระบบ
            </span>
            <span className="flex text-xs text-gray-500">
              เข้าสู่ระบบโดยใช้ชื่อผู้ใช้และรหัสผ่าน หรือ ลงทะเบียน
            </span>
            <button
          ...
          <div className="flex flex-col justify-center w-full mt-4">
            ...
            <div className="flex justify-end mt-1 w-full">
              <span className="text-[#FFA500] text-xs cursor-pointer">
                ลืม Password?
              </span>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-center items-center text-xs text-gray-50 letter-spacing-1 w-full mt-5 gap-2">
          <span className="letter-spacing-1">
            Copyright &copy; 2025{" "}
            <strong onClick={() => router.push("/")} className="cursor-pointer">
              The New You Academy.
            </strong>{" "}
            All rights reserved.
          </span>
          <span className="letter-spacing-1 mt-[-5px]">
