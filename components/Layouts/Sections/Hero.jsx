...
export default function Hero() {
  return (
    <section className="bg-white dark:bg-gray-800">
      ...
      <div className="grid max-w-screen-xl mx-auto px-4 py-2 lg:gap-12 xl:gap-4 lg:py-12 lg:grid-cols-2">
        ...
        <div className="flex flex-col items-start justify-center sm:mt-6">
          <h1 className="max-w-2xl mb-4 text-lg font-extrabold tracking-tight leading-5 md:text-lg xl:text-2xl sm:text-lg dark:text-white">
            {heroContent.contents.title}
          </h1>
          <div className="max-w-2xl font-light text-gray-700 lg:mb-8 md:text-md lg:text-md dark:text-gray-400">
            <ul className="list-disc pl-5 text-md lg:text-md xl:text-lg">
